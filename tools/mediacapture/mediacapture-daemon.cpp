...
rtError rtCaptureRegistryObject::pipelineMediaStart( rtString pipelineName )
{
   ...
   pthread_mutex_lock( &gMutex );
   snprintf(work, sizeof(work), "%llu %s %llu start", gMediaConsumptionOrdinal++, pipelineName.cString(), now);
   str.append( work );
...
rtError rtCaptureRegistryObject::pipelineMediaStop( rtString pipelineName )
{
   ...
   pthread_mutex_lock( &gMutex );
   snprintf(work, sizeof(work), "%llu %s %llu stop", gMediaConsumptionOrdinal++, pipelineName.cString(), now);
   str.append( work );
   gMediaConsumptionInfo.push_back( str );
   pthread_mutex_unlock( &gMutex );
