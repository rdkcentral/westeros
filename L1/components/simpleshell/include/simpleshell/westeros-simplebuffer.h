...
// UNIT_TEST pattern macros for testing static functions
#ifdef UNIT_TEST
#define STATIC_TEST                    // Empty for functions - removes static for external linkage
#define STATIC_TEST_CONST extern const // Explicit extern const for interface structures
#else
