 ...
 * This file uses the STATIC_TEST macro to conditionally make internal functions
 * testable. When UNIT_TEST is defined (during test builds), STATIC_TEST expands
 * to nothing, making functions externally visible. In production builds, STATIC_TEST
 * expands to 'static', keeping functions file-local for encapsulation.
 * 
 * This approach allows comprehensive unit testing of protocol handlers while
 * maintaining proper encapsulation in production code.
 */
...
STATIC_TEST void wstLDBBufferDestroy(struct wl_ldb_buffer *buffer)
{
   int i;
...
STATIC_TEST void wstILDBBufferDestroy(struct wl_client *client,
                                 struct wl_resource *resource)
{
   wl_resource_destroy(resource);
}

STATIC_TEST_CONST struct wl_buffer_interface linux_dmabuf_buffer_interface = {
   wstILDBBufferDestroy
};

STATIC_TEST void wstLDBDestroyBuffer(struct wl_resource *resource)
{
...
STATIC_TEST void wstILDBParamsDestroy(struct wl_client *client, struct wl_resource *resource)
{
   wl_resource_destroy(resource);
}

STATIC_TEST void wstILDBParamsAdd(struct wl_client *client,
...
STATIC_TEST void wstLDBParamsCreate(struct wl_client *client,
                               struct wl_resource *resourceParams,
                               uint32_t buffer_id,
                               int32_t width,
                               int32_t height,
...
STATIC_TEST void wstILDBParamsCreate(struct wl_client *client,
                               struct wl_resource *resourceParams,
                               int32_t width, 
                               int32_t height,
                               uint32_t format, 
...
STATIC_TEST void  wstILDBParamsCreateImmed(struct wl_client *client,
                                     struct wl_resource *resourceParams,
                                     uint32_t buffer_id,
                                     int32_t width,
                                     int32_t height,
...
STATIC_TEST_CONST struct zwp_linux_buffer_params_v1_interface zwp_linux_buffer_params_interface = {
...
STATIC_TEST void wstLDBDestroyParams(struct wl_resource *resourceParams)
{
   struct wl_ldb_buffer *buffer;
...
STATIC_TEST void wstILDBDestroy(struct wl_client *client, struct wl_resource *resource)
{
   wl_resource_destroy(resource);
}

STATIC_TEST void wstILDBCreateParams(struct wl_client *client,
...
STATIC_TEST_CONST struct zwp_linux_dmabuf_v1_interface linux_dmabuf_interface = {
   wstILDBDestroy,
   wstILDBCreateParams
};

STATIC_TEST void wstLDBBind(struct wl_client *client, void *data, uint32_t version, uint32_t id)
{
...
wl_ldb* WstLDBInit( struct wl_display *display, struct wayland_ldb_callbacks *callbacks, void *userData )
{
   ...
   {
      printf("westeros-ldb: WstLDBInit: exit: invalid parameters (display=%p, callbacks=%p)\n", display, callbacks);
      return NULL;
   }
...
void *WstLDBBufferGetBuffer(struct wl_ldb_buffer *buffer)
{
   ...
   // Return the buffer itself as the opaque handle
   return (void*)buffer;
}
